Feature: 5_0_2_Dettaglio_Programmi_Organizzatore_DaAssegnare_CheckElement_Uso_dei_Filtri_ANDROID
  Scenario: 5_0_2_Dettaglio_Programmi_Organizzatore_DaAssegnare_CheckElement_Uso_dei_Filtri_ANDROID
